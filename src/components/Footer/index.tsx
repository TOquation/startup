...
const Footer = () => {
  ...
  return (
    <footer className="dark:bg-gray-dark relative z-10 bg-white pt-16 pb-10 md:pt-20 md:pb-12">
      <div className="container">
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row md:gap-0">
          ...
          >
            <ul className="flex flex-wrap items-center justify-center gap-6 md:gap-8">
              <li>
                <Link
                  href="/#about"
                  className="text-body-color hover:text-primary dark:text-body-color-dark dark:hover:text-primary text-base transition-colors duration-300"
                >
                  About
                </Link>
              </li>
          ...
          >
            <a
              href="https://github.com/TOquation"
              aria-label="GitHub"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/in/oparaji-tochi-757b02291"
              aria-label="LinkedIn"
              target="_blank"
              rel="noopener noreferrer"
              className="text-body-color hover:text-primary dark:text-body-color-dark dark:hover:text-primary transition-colors duration-300"
        ...
        {/* Divider */}
        <div className="my-8 h-px w-full bg-linear-to-r from-transparent via-gray-300 to-transparent dark:via-gray-700"></div>
        ...
        <motion.p
          ...
          className="text-body-color dark:text-body-color-dark text-center text-sm"
        >
          © {currentYear} Tochi. All rights reserved.
        </motion.p>
      </div>
    </footer>
  );
